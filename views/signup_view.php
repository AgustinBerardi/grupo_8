    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <?php
                    $user= $this->session->flashdata('usuario');
                    if(is_array($user)){
                        	$nombre = $user['nombre'];
                            $email = $user['email'];  
                    ...
                    $f_nacimiento = isset($f_nacimiento)?$f_nacimiento:"1998-06-03";
					...
					$password= array('name' => 'password' , 'placeholder' => 'Contraseña','value'=> $password);
					$conf_password= array('name' => 'conf_password', 'placeholder' => 'Confirmar Contraseña','value'=> $conf_password);
					...
					<input type="date" name="fecha" min="1900-01-01" max="1998-06-03" value="<?=$f_nacimiento?>" required=”required”><br /><err><?=form_error('fecha')?></err>
					<p>Nacionalidad:</p>
					...
					?></p></err>
					<p><a class="btn btn-default" href="<?=site_url().'home_controller'?>">Volver atras</a></p>
                </div>
            </div>
        </div>
