<?php
	...
	$submit = array('name' => 'submit', 'value' => 'Recordar contraseña', 'title' => 'Recordar password' , 'class' => 'btn');
        ...
        <div class="row">
            <div class="box">
				...
				<center>
					...
					?>
					<p>
					<a class="btn btn-info" href=<?=site_url().'login_controller';?>>Volver atras</a>
					</p>
                </center>
				</div>
            </div>
