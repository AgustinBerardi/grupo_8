        ...
        <div class="row">
            ...
            if($this->session->userdata('perfil')=='administrador')
                ...
                if($this->session->userdata('premium')==1)
                    ...
                    echo 'Comun';
                    echo '<br>';
                    echo anchor('user_controller/ingresar_tarjeta_premium','Hacerse premium',"class='btn'");                        
                }
                
            ?>
			<p>Contrase&ntilde;a</p>
			<?=anchor(site_url().'comun_controller/cambiar_password','Cambiar password',"class='btn'")?>
			<p>E-Mail</p>
			...
			<?php if($this->session->userdata('perfil')!='administrador')
                       echo anchor(site_url().'user_controller/eliminar_cuenta_opciones','Eliminar cuenta',"class='btn'");?>
