<?php
    ...
    $data=$this->session->flashdata('usuario');
	...
	$password = array('name' => 'password',	'placeholder' => 'introduce tu contrase&ntilde;a','value' => $password );
        ...
        <div class="row">
            <div class="box">
				...
				<center>
					...
					?><p>
					<a class="btn btn-info" href=<?=site_url().'login_controller/recordar_pass';?>>Olvide mi contrase&ntilde;a</a>
					</p>
					<a class="btn btn-info" href=<?=site_url().'home_controller';?>>Volver atras</a>
                </center>
				</div>
            </div>
        </div>
