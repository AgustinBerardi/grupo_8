            ...
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="<?=base_url().'CSS/img/bolson.jpg'?>" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<?=base_url().'CSS/img/laprida.jpg'?>" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<?=base_url().'CSS/img/viedma.jpg'?>" alt="">
                            </div>
                        </div>
                    ...
                    <h2 class="brand-before">
                        <small><?= $this->session->userdata('username');?>, bienvenido a</small>
                    </h2>
                    <h1 class="brand-name">Couch Inn</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>Por
                            <strong>Pi-Soft</strong>
                        </small>
                    </h2>
                </div>
            </div>
