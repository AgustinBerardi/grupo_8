        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
								...
								<br/> <?=anchor(site_url().'user_controller/eliminar_cuenta','Borrar cuenta',"class = 'btn btn-info'");?>
										<?=anchor(site_url().'user_controller/mi_perfil','Cancelar',"class = 'btn btn-info'");?>
		          </h2></center> 
                </div>
            </div>
        </div>
