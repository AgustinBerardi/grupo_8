...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
					<p>Informacion cambiada correctamente
					<?= $this->session->userdata('username');?><br /></p>
					<center>
					<?=anchor(site_url().'comun_controller/modificar_informacion','Volver atras',"class='btn btn-info'");?>
					<br>
					<br>
					<?=anchor(site_url().'home_controller','Volver al home',"class = 'btn btn-info'");?>
					</center>
                </div>
            </div>
        </div>
