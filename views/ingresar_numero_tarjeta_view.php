<?php
   	...
   	$codigo = array('name' => 'codigo', 'placeholder' => 'Ingrese su numero de tarjeta','maxlength' => 16);
    $seguridad =array('name' => 'seguridad', 'placeholder' => 'Ingrese su codigo de seguridad','maxlength' => 3);
    $submit = array('name' => 'submit', 'value' => 'Aceptar', 'title' => 'Aceptar' , 'class' => 'btn');
    $nombre = array('name' => 'nombre', 'placeholder' => 'Nombre del usuario');
    $apellido = array('name' => 'apellido', 'placeholder' => 'Apellido del usuario');
    $fecha_vencimiento_tarjeta = array( 'type' => 'date', 'name' => 'fecha', 'required'=> 'required');
